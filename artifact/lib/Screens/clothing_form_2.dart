...
class ClothingFormWidget extends StatefulWidget {
  ClothingFormWidget(
    {Key? key, required this.clothingFormInfo, required this.onRemove, this.index}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  items: widget.clothingFormInfo.genders.map((valueItem) {
                  ...
                  validator: (value) {
                    return !(widget.genderValue == '') ? null : "Please select a gender";
                  },
                ),
                ...
                DropdownButtonFormField(
                  ...
                  validator: (value) {
                    return !(widget.itemValue == '') ? null : "Please select an item";
                  },
                ),
                const SizedBox(height: 12),
                DropdownButtonFormField(
                  ...
                  validator: (value) {
                    return !(widget.sizeValue == '') ? null : "Please select a size";
                  },
                ),
                const SizedBox(height: 12),
                DropdownButtonFormField(
                  ...
                  items: widget.clothingFormInfo.emergency.map((valueItem) {
                          return DropdownMenuItem(
                            value: valueItem,
                            child: Text(valueItem),
                            );
                  ...
                  validator: (value) {
                    return !(widget.emergencyValue == '') ? null : "Please indicate if emergency";
                  },
                ),
                const SizedBox(height: 12),
                TextFormField(
                  controller: widget.ageController,
                  onChanged: (value) => widget.clothingFormInfo.ageValue = value,
                  onSaved: (value) => widget.clothingFormInfo.ageValue = value,
                  validator: (value) => !(value == null || value.isEmpty) ? null : "Please enter an age",
                  decoration: const InputDecoration(
                    contentPadding: EdgeInsets.symmetric(horizontal: 12),
                    border: OutlineInputBorder(),
                    hintText: "Enter Age",
                ...
                TextFormField(
                  ...
                  onChanged: (value) => widget.clothingFormInfo.notesValue = value,
                  onSaved: (value) => widget.clothingFormInfo.notesValue = value,
                  validator: (value) => !(value == null || value.length < 3) ? null : "Please enter 'N/A' if not applicable",
                  decoration: const InputDecoration(
                    contentPadding: EdgeInsets.symmetric(horizontal: 12),
                    border: OutlineInputBorder(),
