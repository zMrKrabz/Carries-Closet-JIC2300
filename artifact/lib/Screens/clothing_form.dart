                      ...
                      children: [
                        ...
                        DropdownButtonFormField(
                          decoration: const InputDecoration(
                            ...
                            EdgeInsets.symmetric(horizontal: 12),
                            border: OutlineInputBorder(),
                            hintText: "Select a fitting",
                            labelText: "Fitting",
                          ),
                          value: widget.sizeFittingValue,
                          items: widget.clothingFormInfo.sizes.map((valueItem) {
                            return DropdownMenuItem(
                              value: valueItem,
                              child: Text(valueItem),
                          ...
                          onChanged: (value) {
                            setState(() {
                              widget.sizeFittingValue = value as String;
                            });
                          },
                          onSaved: (value) {
                            setState(() {
                              widget.clothingFormInfo.sizeFittingValue = value as String;
                            });
                          },
                          validator: (value) {
                            return !(widget.sizeFittingValue == '')
                                ? null
                                : "Please select a fitting";
                          },
                        ),
                        const SizedBox(height: 12),
                        DropdownButtonFormField(
